...
/* ============================================================
   STREAMLIT HEADER
   Keep transparent so sidebar reopen control still works
============================================================ */
...
button[data-testid="stSidebarCollapsedControl"]:hover {{
    ...
    box-shadow:
        0 0 30px rgba(93,158,255,0.75) !important;
...
/* Fallback header button styling */
...
<div class="kpi-value">{format_percent(achieved_avg)}</div>
<div class="kpi-sub">Current target achievement</div>
</div>
            """,
    ...
    with c2:
        ...
        st.markdown(
            ...
            f"""
<div class="kpi-card">
<div class="kpi-label">COMPETITOR PROJECTION</div>
<div class="kpi-value">{format_percent(projection_avg)}</div>
<div class="kpi-sub">Competitor performance level</div>
</div>
            """,
    ...
    with c3:
        ...
        st.markdown(
            ...
            f"""
<div class="kpi-card">
<div class="kpi-label">PERFORMANCE GAP</div>
<div class="kpi-value">{format_percent(backlog_percent_avg)}</div>
<div class="kpi-sub">Gap against competitor</div>
</div>
            """,
    ...
    with c4:
        ...
        st.markdown(
            ...
            f"""
<div class="kpi-card">
<div class="kpi-label">BACKLOG UNITS</div>
<div class="kpi-value">{format_number(backlog_units_sum)}</div>
<div class="kpi-sub">Units behind competitor</div>
</div>
            """,
...
Executive Interpretation
    ...
    if pd.notna(backlog_percent_avg):
        ...
        if backlog_percent_avg <= 5:

            insights.append(
                "Competitive backlog is currently within a manageable range."
            )

        elif backlog_percent_avg <= 15:

            insights.append(
                "Competitive pressure is moderate and requires focused recovery."
            )

        else:

            insights.append(
                "Competitive pressure is high and requires immediate management attention."
            )
    ...
    if target_remaining_sum > 0:
        ...
        insights.append(
            f"{format_number(target_remaining_sum)} units remain to achieve the current target."
        )
    ...
    if not insights:
        ...
        insights.append(
            "Insufficient data is currently available to generate executive insights."
        )
    ...
    for index, insight in enumerate(insights, start=1):
        ...
        st.markdown(
            ...
            f"""
<div class="kpi-card" style="min-height:80px; margin-bottom:12px;">
...
<div class="kpi-value">{format_number(input_1_sum)}</div>
<div class="kpi-sub">Current achieved units</div>
</div>
            """,
...
<div class="kpi-value">{format_number(input_2_sum)}</div>
<div class="kpi-sub">Current target units</div>
</div>
            """,
...
<div class="kpi-value">{format_number(target_remaining_sum)}</div>
<div class="kpi-sub">Target still required</div>
</div>
            """,
    ...
    with c4:
        ...
        st.markdown(
            ...
            f"""
<div class="kpi-card">
<div class="kpi-label">DAILY RECOVERY</div>
<div class="kpi-value">{format_number(target_per_day_avg)}</div>
<div class="kpi-sub">Required units per day</div>
</div>
            """,
    ...
    if selected_business_area == "All":
        ...
        fig_actual_target.add_trace(
            ...
            go.Scatter(
                ...
                x=actual_target_df[month_column],

                y=actual_target_df["Actual"],
        ...
        if len(actual_target_df) >= 2:
            ...
            actual_values = (
                actual_target_df["Actual"]
                .tail(2)
                .tolist()
            )

            target_values = (
                actual_target_df["Target"]
                .tail(2)
                .tolist()
            )
...
# ============================================================
# PAGE 04 — BUSINESS AREA COMPARISON
# ============================================================
