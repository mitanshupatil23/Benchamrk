...
# NEW CALCULATION:
#
# (PAGE 2 SCORECARD 1 × PAGE 1 SCORECARD 3)
# +
# PAGE 2 SCORECARD 1
#
# PAGE 2 SCORECARD 1 = INPUT 1
# PAGE 1 SCORECARD 3 = PERFORMANCE GAP
# ============================================================

if pd.notna(performance_gap_value):

    page4_scorecard_4_value = round(
    ...
    page4_scorecard_4_value = np.nan


# ============================================================
# PROJECTED UNITS
#
# KEPT AS ORIGINAL CALCULATION FOR
...
<div class="kpi-value">
{format_number(page4_scorecard_4_value)}
</div>

<div class="kpi-sub">
(Input 1 × Target Gap %) + Input 1
</div>
...
Measure operational backlog, available excess and the net exposure after excess.
    ...
    # PAGE 5 SCORECARD 1
    #
    # SAME VALUE AS PAGE 1 SCORECARD 4
    # ========================================================
...
Backlog Units
    ...
    # PAGE 5 SCORECARD 2
    #
    # SAME VALUE AS PAGE 4 SCORECARD 2
    # ========================================================
