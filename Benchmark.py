...
# ============================================================
# UPDATED DYNAMIC EXCESS / BACKLOG CALCULATION
# ============================================================
#
# FORMULA:
#
...
if net_position > 0:
    ...
    dynamic_kpi_label = "↑ EXCESS"

    dynamic_kpi_value = difference_value

    dynamic_kpi_sub = (
        "Net excess after backlog and target adjustment"
    )
    ...
    dynamic_kpi_label = "↓ BACKLOG"

    dynamic_kpi_value = difference_value

    dynamic_kpi_sub = (
        "Net backlog after excess and target adjustment"
    )
    ...
    dynamic_kpi_label = "BALANCED"

    dynamic_kpi_value = 0

    dynamic_kpi_sub = (
        "Excess, backlog and target requirement are balanced"
    )
...
<div class="kpi-label {dynamic_label_class}">
{dynamic_kpi_label}
</div>

<div class="{dynamic_value_class}">
{format_number(dynamic_kpi_value)}
</div>
...
Executive Interpretation
    ...
    if net_position > 0:
        ...
        insights.append(
            f"After adjusting Total Excess, Total Backlog Units and "
            f"Target Need to Achieve, the business has a net excess of "
            f"{format_number(difference_value)} units."
        )
        ...
        insights.append(
            f"After adjusting Total Excess, Total Backlog Units and "
            f"Target Need to Achieve, the business has a net backlog of "
            f"{format_number(difference_value)} units."
        )
        ...
        insights.append(
            "Total Excess, Total Backlog Units and Target Need to Achieve "
...
Performance gap and competitive pressure analysis.
    ...
    if selected_business_area == "All":
        ...
        month_column
        and "backlog_percent_numeric" in analysis_df.columns
    ):
